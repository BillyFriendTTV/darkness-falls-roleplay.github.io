...
#extra
 ::list{type="success"}
 - **active** development
 - **career paths** both legitimate and criminal
 - **Industry-leading** support services
 - **Not pay to win**, and never will be
 - custom-designed resources
 ::
...
#description
Navigate to Coming Soon. The browser will ask if you would like to launch FiveM.
::
...
By Console Command
#description
Open the FiveM console using the `F8` key and run [`connect ....`](/server-docs/getting-started/how-to-connect#by-console-command)
::
...
By Server Browser
#description
Search for `Coming Soon` in the [FiveM server browser](https://servers.fivem.net/).
::
::
...
:icon{name="noto:judge"} [Laws]() · :icon{name="noto:gear"} [Discord]()
::
